...
/**
 * مرز ماژول پرسش از متخصص — قاعده ۱.
 */
final class ModuleBoundaryTest extends TestCase
{
    public function test_the_module_imports_no_model_from_another_module(): void
    {
        ...
        foreach ($this->sourceFiles() as $file) {
            ...
            preg_match_all('/^use (App\\\\Modules\\\\(?!Expert)[^;]+);$/m', $source, $matches);
        ...
        $this->assertSame([], $offenders, 'ماژول پرسش از متخصص نباید کلاس ماژول دیگری را import کند.');
    }
    ...
    private function sourceFiles(): array
    {
        $directory = new RecursiveIteratorIterator(
            new RecursiveDirectoryIterator(base_path('app/Modules/Expert')),
        );
