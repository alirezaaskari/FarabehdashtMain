 ...
 *
 * گسترده‌تر از {@see ToolCategory}: ارتعاش، ارگونومی و آمار مواجهه هنوز
 * ابزار ندارند، ولی کاربرشان مقاله، فایل و دوره لازم دارد. دستیار برای این
 * خطرها همان محتوا را پیشنهاد می‌کند و صادقانه می‌گوید ابزارش هنوز نیامده.
 */
enum Hazard: string
{
    case Noise = 'noise';
