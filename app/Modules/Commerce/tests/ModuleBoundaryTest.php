...
final class ModuleBoundaryTest extends TestCase
{
    public function test_the_module_imports_no_model_from_another_module(): void
    {
        ...
        foreach ($this->sourceFiles() as $file) {
            ...
            preg_match_all('/^use (App\\\\Modules\\\\(?!Commerce)[^;]+);$/m', $source, $matches);
        ...
        $this->assertSame([], $offenders, 'ماژول تجارت نباید کلاس ماژول دیگری را import کند.');
    }
    ...
    private function sourceFiles(): array
    {
        $directory = new RecursiveIteratorIterator(
            new RecursiveDirectoryIterator(base_path('app/Modules/Commerce')),
        );
